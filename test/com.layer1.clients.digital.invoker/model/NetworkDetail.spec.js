...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.NetworkDetail();
  });
  ...
  describe('NetworkDetail', function() {
    it('should create an instance of NetworkDetail', function() {
      // uncomment below and update the code to test NetworkDetail
      //var instance = new DigitalAsset.NetworkDetail();
      //expect(instance).to.be.a(DigitalAsset.NetworkDetail);
    });
