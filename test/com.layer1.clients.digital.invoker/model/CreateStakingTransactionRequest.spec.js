...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.CreateStakingTransactionRequest();
  });
  ...
  describe('CreateStakingTransactionRequest', function() {
    it('should create an instance of CreateStakingTransactionRequest', function() {
      // uncomment below and update the code to test CreateStakingTransactionRequest
      //var instance = new DigitalAsset.CreateStakingTransactionRequest();
      //expect(instance).to.be.a(DigitalAsset.CreateStakingTransactionRequest);
    });
