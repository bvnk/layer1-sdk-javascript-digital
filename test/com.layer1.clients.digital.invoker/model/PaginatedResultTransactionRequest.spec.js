...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.PaginatedResultTransactionRequest();
  });
  ...
  describe('PaginatedResultTransactionRequest', function() {
    it('should create an instance of PaginatedResultTransactionRequest', function() {
      // uncomment below and update the code to test PaginatedResultTransactionRequest
      //var instance = new DigitalAsset.PaginatedResultTransactionRequest();
      //expect(instance).to.be.a(DigitalAsset.PaginatedResultTransactionRequest);
    });
