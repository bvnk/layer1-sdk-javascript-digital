...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.TransactionMetadata();
  });
  ...
  describe('TransactionMetadata', function() {
    it('should create an instance of TransactionMetadata', function() {
      ...
      //var instance = new DigitalAsset.TransactionMetadata();
      //expect(instance).to.be.a(DigitalAsset.TransactionMetadata);
    });
