...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.UpdateAssetPoolRequest();
  });
  ...
  describe('UpdateAssetPoolRequest', function() {
    it('should create an instance of UpdateAssetPoolRequest', function() {
      // uncomment below and update the code to test UpdateAssetPoolRequest
      //var instance = new DigitalAsset.UpdateAssetPoolRequest();
      //expect(instance).to.be.a(DigitalAsset.UpdateAssetPoolRequest);
    });
