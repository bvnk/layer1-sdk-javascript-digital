...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.CreateAddressRequest();
  });
  ...
  describe('CreateAddressRequest', function() {
    it('should create an instance of CreateAddressRequest', function() {
      ...
      //var instance = new DigitalAsset.CreateAddressRequest();
      //expect(instance).to.be.a(DigitalAsset.CreateAddressRequest);
    });
