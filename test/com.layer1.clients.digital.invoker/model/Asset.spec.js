...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.Asset();
  });
  ...
  describe('Asset', function() {
    it('should create an instance of Asset', function() {
      ...
      //var instance = new DigitalAsset.Asset();
      //expect(instance).to.be.a(DigitalAsset.Asset);
    });
    ...
    it('should have the property decimalPrecision (base name: "decimalPrecision")', function() {
      // uncomment below and update the code to test the property decimalPrecision
      //var instance = new DigitalAsset.Asset();
      //expect(instance).to.be();
    });
