...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.PaginatedResultTransaction();
  });
  ...
  describe('PaginatedResultTransaction', function() {
    it('should create an instance of PaginatedResultTransaction', function() {
      // uncomment below and update the code to test PaginatedResultTransaction
      //var instance = new DigitalAsset.PaginatedResultTransaction();
      //expect(instance).to.be.a(DigitalAsset.PaginatedResultTransaction);
    });
