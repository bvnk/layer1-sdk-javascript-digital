...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.ScreeningMetadata();
  });
  ...
  describe('ScreeningMetadata', function() {
    it('should create an instance of ScreeningMetadata', function() {
      // uncomment below and update the code to test ScreeningMetadata
      //var instance = new DigitalAsset.ScreeningMetadata();
      //expect(instance).to.be.a(DigitalAsset.ScreeningMetadata);
    });
