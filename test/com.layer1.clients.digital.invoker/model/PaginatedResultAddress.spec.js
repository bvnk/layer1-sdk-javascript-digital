...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.PaginatedResultAddress();
  });
  ...
  describe('PaginatedResultAddress', function() {
    it('should create an instance of PaginatedResultAddress', function() {
      // uncomment below and update the code to test PaginatedResultAddress
      //var instance = new DigitalAsset.PaginatedResultAddress();
      //expect(instance).to.be.a(DigitalAsset.PaginatedResultAddress);
    });
