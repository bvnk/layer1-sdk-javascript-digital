...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.EstimateTransactionFeeRequest();
  });
  ...
  describe('EstimateTransactionFeeRequest', function() {
    it('should create an instance of EstimateTransactionFeeRequest', function() {
      // uncomment below and update the code to test EstimateTransactionFeeRequest
      //var instance = new DigitalAsset.EstimateTransactionFeeRequest();
      //expect(instance).to.be.a(DigitalAsset.EstimateTransactionFeeRequest);
    });
