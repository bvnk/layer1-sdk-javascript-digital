...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.ReturnRequest();
  });
  ...
  describe('ReturnRequest', function() {
    it('should create an instance of ReturnRequest', function() {
      // uncomment below and update the code to test ReturnRequest
      //var instance = new DigitalAsset.ReturnRequest();
      //expect(instance).to.be.a(DigitalAsset.ReturnRequest);
    });
