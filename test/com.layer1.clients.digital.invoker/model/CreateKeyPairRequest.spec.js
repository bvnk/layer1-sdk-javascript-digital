...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.CreateKeyPairRequest();
  });
  ...
  describe('CreateKeyPairRequest', function() {
    it('should create an instance of CreateKeyPairRequest', function() {
      // uncomment below and update the code to test CreateKeyPairRequest
      //var instance = new DigitalAsset.CreateKeyPairRequest();
      //expect(instance).to.be.a(DigitalAsset.CreateKeyPairRequest);
    });
