...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.PaginatedScreenings();
  });
  ...
  describe('PaginatedScreenings', function() {
    it('should create an instance of PaginatedScreenings', function() {
      // uncomment below and update the code to test PaginatedScreenings
      //var instance = new DigitalAsset.PaginatedScreenings();
      //expect(instance).to.be.a(DigitalAsset.PaginatedScreenings);
    });
