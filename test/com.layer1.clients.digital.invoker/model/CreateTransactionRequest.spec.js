...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.CreateTransactionRequest();
  });
  ...
  describe('CreateTransactionRequest', function() {
    it('should create an instance of CreateTransactionRequest', function() {
      // uncomment below and update the code to test CreateTransactionRequest
      //var instance = new DigitalAsset.CreateTransactionRequest();
      //expect(instance).to.be.a(DigitalAsset.CreateTransactionRequest);
    });
