...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.PaginatedExports();
  });
  ...
  describe('PaginatedExports', function() {
    it('should create an instance of PaginatedExports', function() {
      // uncomment below and update the code to test PaginatedExports
      //var instance = new DigitalAsset.PaginatedExports();
      //expect(instance).to.be.a(DigitalAsset.PaginatedExports);
    });
