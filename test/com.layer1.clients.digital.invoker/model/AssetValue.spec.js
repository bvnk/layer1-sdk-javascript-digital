...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalAsset.AssetValue();
  });
  ...
  describe('AssetValue', function() {
    it('should create an instance of AssetValue', function() {
      // uncomment below and update the code to test AssetValue
      //var instance = new DigitalAsset.AssetValue();
      //expect(instance).to.be.a(DigitalAsset.AssetValue);
    });
